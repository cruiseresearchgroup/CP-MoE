...
deepspeed --include localhost:0,1 --master_port 29600 llava/train/train_mem_MOE.py \
    ...
    --previous_task_model_path ./checkpoints/CL4VQA/color-4ep/llava-1.5-7b-lora \
    --version $PROMPT_VERSION \
    --data_path /srv/scratch/cruise/Yang/CL4VQA/train/train_q_type.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/CL4VQA/type-4ep/llava-1.5-7b-lora \
    --num_train_epochs 1 \
