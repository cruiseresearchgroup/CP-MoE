...
deepspeed --include localhost:0,1 --master_port 29603 llava/train/train_mem_MOE.py \
    ...
    --data_path /srv/scratch/cruise/Yang/Lora-MoE/SuperNI/task511_reddit_tifu_long_text_summarization/train.json \
    --image_folder /srv/scratch/cruise/Yang/ \
    --previous_task_model_path ./checkpoints_order2/CL4VQA/task181/llama-2-7b-hf-lora \
    --group_by_modality_length False \
    --bf16 True \
    --output_dir ./checkpoints_order2/CL4VQA/task511/llama-2-7b-hf-lora \
    --num_train_epochs 3 \
