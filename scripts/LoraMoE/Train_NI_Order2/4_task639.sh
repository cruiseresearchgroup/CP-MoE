...
deepspeed --include localhost:0,1 --master_port 29603 llava/train/train_mem_MOE.py \
    ...
    --data_path /srv/scratch/cruise/Yang/Lora-MoE/SuperNI/task639_multi_woz_user_utterance_generation/train.json \
    --image_folder /srv/scratch/cruise/Yang/ \
    --previous_task_model_path ./checkpoints_order2/CL4VQA/task1590/llama-2-7b-hf-lora \
    --group_by_modality_length False \
    --bf16 True \
    --output_dir ./checkpoints_order2/CL4VQA/task639/llama-2-7b-hf-lora \
    --num_train_epochs 5 \
