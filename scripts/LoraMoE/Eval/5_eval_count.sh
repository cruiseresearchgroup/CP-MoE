...
RESULT_DIR="./results/CLMoE/count-4ep"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.CLMoE.eval_token_monitor \
        ...
        --question-file /srv/scratch/cruise/Yang/CL4VQA/test/test_q_count.json \
...
python llava/eval/CLMoE/eval_vqav2.py \
    --annotation_file /srv/scratch/cruise/Yang/CL4VQA/test/test_q_count.json \
