...
FILE_NAME="task748_glucose_reverse_cause_event_detection"
MODEL_NAME="task748"
TASK_NAME="task748"
if [ ! -n "$1" ] ;then
    STAGE='Finetune'
...
if [ ! -n "$2" ] ;then
    MODELPATH="./checkpoints_order2/CL4VQA/${MODEL_NAME}/llama-2-7b-hf-lora"
else
    MODELPATH=$2
fi
...
RESULT_DIR="./results_order2/CLMoE/${TASK_NAME}"
